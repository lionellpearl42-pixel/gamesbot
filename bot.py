...
def main():
    ...
    application.add_handler(CommandHandler("verdade", verdade))
    application.add_handler(CommandHandler("consequencia", consequencia))
    application.add_handler(CommandHandler("pergunta", pergunta))
    application.add_handler(CommandHandler("ia", ia))
